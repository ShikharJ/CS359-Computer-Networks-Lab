...
class Node:
    ...
    def __init__(self, port = random.randint(10000, 20000), next_node = None):
        """
        Initialise the node with port (random) and join the network.
        ...
        self.mac = get_mac()
        # ignores the MAC address of the machine.
        ...
        self.predecessor = None # Let's keep them of type dict.
        self.successor = None
        ...
        # enp0s3 is the interface for virtual machine in my system.
        self.ipaddress = self.interfaces['enp0s3'][0]
    ...
    def create_file(self):
        """
        This function will be called by the first nodes to prepare the hash for 100 files and stores in self.files.
        """
    ...
    def menu_to_print(self):
        ...
        if choice == 1:
            ...
            # Print combination of successor and predecessor.
    ...
    def rpc_server(self):
        """
        This will run the XMLRPC Server.
        """
    ...
    def find_successor(self, id):
        ...
        n_dash = self.find_predecessor(id) # n_dash is the list.

        # n_dash will be of type xmlrpc.client.
    ...
    def give_files(self, id):
        """
        This function will give the files for node with ID "id" i.e. all files in [predecessor, id].
    ...
    def join(self, n_dash = None):
        ...
        If n_dash is None then initialise the Chord ring.
        :param n_dash: n' to which we need to contact is list of ID, IP and port.
        ...
        if n_dash is not None:
            ...
            # print("Finger Table Initialised")
            self.update_others()
    ...
    def init_finger_table(self, n_dash, first = False):
        """
        Initialise the finger table using n_dash.
    ...
    def update_others(self):
        ...
        # print("Finished Updating Others")

    def update_finger_table(self, n_list, i):
        """
        :param n_list: List of ID, IP and port of the new node.
        :param i: ith entry in finger table.
        """
    ...
    def list_to_rpc(list = None):
        """
        List is None.
        :param list: The list of ID, IP and port.
